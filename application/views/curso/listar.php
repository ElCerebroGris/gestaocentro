                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Cursos</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($cursos as $c) {
                                                ?>
                                                <tr><td><a href="<?= base_url('curso/ver/'.$c->id_curso) ?>"><?= $c->curso_nome ?></a></td>
                                                    <td><?= $c->curso_preco ?> Kz</td>
                                                    <td><?= $c->duracao ?> Semanas</td>
                                                    <td>
                                                        <a class="btn btn-danger btn-sm" 
                                                           onclick="return confirm('Deseja realmente excluir?');"
                                                           href="<?= base_url('curso/remover/'.$c->id_curso) ?>">Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>

        ...
        <div class="page-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-content fade-in-up">
                    <?php if ($this->session->flashdata('tipo') == 1) { ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Turmas</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($turmas as $t) {
                                                ?>
                                                <tr><td><a href="<?= base_url('turma/ver/' . $t->id_turma) ?>"><?= $t->turma_nome ?></a></td>
                                                    <td><a href="<?= base_url('curso/ver/' . $t->id_curso) ?>"><?= $t->curso_nome ?></a></td>
                                                    <td><?= $t->estado_descricao ?></td>
                                                    <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 3) { ?>
                                                        <td>
                                                            <!--<a class="btn btn-info" href="#">Editar</a>-->
                                                            <a class="btn btn-danger" 
                                                               onclick="return confirm('Deseja realmente excluir?');"
                                                               href="<?= base_url('turma/remover/' . $t->id_turma) ?>">Eliminar</a>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>

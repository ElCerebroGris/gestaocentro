...
<html lang="en">
    <head>
        ...
        <title>Adicionar Sala de Aula</title>
                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Adicionar Sala de Aula</div>
                                ...
                                <div class="ibox-body">
                                    <form action="<?= base_url() ?>salaaula/addPost" method="POST">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input name="capacidade" class="form-control" type="number" required="">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <span class="help-block">(Ex: Sala de Aula Prática)</span>
                                            </div>
                                        </div>

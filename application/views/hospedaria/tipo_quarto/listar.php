...
<html lang="en">
    ...
    <head>
        ...
        <title>Lista de Tipo de Quarto</title>
                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Tipo de Quarto</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table1" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($tipo as $s) {
                                                ?>
                                                <tr><td><?= $s->descricao_tipo ?></td>
                                                    <td><?= $s->preco ?> Kz</td>
                                                    <td>
                                                        <a class="btn btn-danger btn-sm" 
                                                           onclick="return confirm('Deseja realmente excluir?');"
                                                           href="<?= base_url('hospedaria/tipoquarto/remover/'.$s->id_tipo_quarto) ?>">Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>

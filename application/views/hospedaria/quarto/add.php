                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Adicionar Quarto</div>
                                ...
                                <div class="ibox-body">
                                    <form action="<?= base_url() ?>hospedaria/quarto/addPost" method="POST">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row col-sm-6 form-group">
                                                ...
                                                <select name="id_tipo" class="form-control select2_demo_1">
                                                    <optgroup label="Todos">
                                                        <?php foreach ($tipo as $t) {
                                                            ?>
                                                            <option value="<?= $t->id_tipo_quarto ?>">
                                                                <?=$t->descricao_tipo .' | '. $t->preco ?></option>
                                                        <?php } ?>
                                                    </optgroup>
                                                </select>
                                            </div>

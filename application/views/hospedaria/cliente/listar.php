                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($clientes as $a) {
                                                ?>
                                                <tr>
                                                    <td><a href="<?= base_url('aluno/ver/' . $a->id_cliente) ?>"><?= $a->nome_cliente ?></a></td>
                                                    <td><?= $a->bi_num ?></td>
                                                    <td><?= $a->sexo ?></td>
                                                    <td></td>
                                                    <td>
                                                        <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 6) { ?>
                                                            <a class="btn btn-info btn-sm" 
                                                               href="<?= base_url('hospedaria/cliente/checkin/' . $a->id_cliente) ?>">Inscrever</a>
                                                            <a class="btn btn-info btn-sm" href="<?= base_url('hospedaria/cliente/editar/'.$a->id_cliente) ?>">Editar</a>    
                                                            <a class="btn btn-sm btn-danger" 
                                                               onclick="return confirm('Deseja realmente excluir?');"
                                                               href="<?= base_url('aluno/remover/' . $a->id_cliente) ?>">Eliminar</a>
                                                           <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>

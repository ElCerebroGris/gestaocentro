                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Lista de Horários</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table1" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($horarios as $h) {
                                                ?>
                                                <tr><td><?= $h->horario_descricao ?></td>
                                                    <td>
                                                        <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 3) { ?>
                                                            <a class="btn btn-sm btn-danger" 
                                                               onclick="return confirm('Deseja realmente excluir?');"
                                                               href="<?= base_url('horario/remover/' . $h->id_horario) ?>">Eliminar</a>
                                                           <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>

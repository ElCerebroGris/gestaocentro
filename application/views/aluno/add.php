                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Adicionar Aluno</div>
                                ...
                                <div class="ibox-body">
                                    <form action="<?= base_url() ?>aluno/addPost" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input name="num_bi" class="form-control" type="text" required="">
                                            </div>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input name="telefone2" class="form-control" type="text">
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Email:</label>

                ...
                <div class="page-content fade-in-up">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ibox">
                                <div class="ibox-head">
                                    <div class="ibox-title">Alunos Pré inscritos</div>
                                            ...
                                            <?php foreach ($alunos as $a) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= base_url('aluno/ver/'.$a->id_aluno) ?>">
                                                        <?= $a->aluno_nome.' '.$a->sobrenome ?></a></td>
                                                    <td>
                                                        <a class="btn btn-info btn-sm" 
                                                           href="<?= base_url('aluno/matricula/'.$a->id_aluno) ?>">Inscrever</a>
                                                        <a class="btn btn-info btn-sm" href="<?= base_url('aluno/editar/'.$a->id_aluno) ?>">Editar</a>
                                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Deseja realmente excluir?');"
                                                               href="<?= base_url('aluno/remover/' . $a->id_aluno) ?>">Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
